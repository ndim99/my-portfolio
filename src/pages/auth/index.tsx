      ...
      <div className="w-full flex flex-col mx-auto 2xl:gap-8 lg:gap-7 gap-6 2xl:p-6 lg:p-5 p-4 max-w-5xl rounded-lg shadow-md bg-white dark:bg-black">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="fontSizeFrom2xl text-primary-colors font-bold text-center">
            Why I Integrated Privy for Authentication Across Several
            Applications
          </h1>
          <ul className="list-disc text-secondary-colors fontSizeFromLg flex flex-col gap-2 pl-6">
            <li>
              ...
              authentication checks, providing a robust way to manage user
              access in applications.
            </li>
            <li>
              <b>Web3 Integration:</b> Offers seamless wallet-based
              authentication for Web3 projects alongside traditional methods
              like email, enhancing versatility.
            </li>
            <li>
            ...
            <li>
              <b>Developer-Friendly:</b> Its intuitive API and implementation
              save time, making it easier to build secure, user-friendly sign-up
              and login flows.
            </li>
          </ul>
        </div>
          ...
          <div className="flex flex-col 2xl:gap-4 gap-3">
            ...
            <ul className="list-disc pl-6 text-secondary-colors fontSizeFromLg flex flex-col gap-2">
              <li>
                ...
                authentication and redirection, making it reusable across
